			...
			addData: function (data) { //parse data
				...
				if(p.removeRow)
				{
					...
					$(t).find('tr').each(function(i, item)
					{
						...
						var removeElement = $(this).find('td:last');
						removeElement.addClass('remove');
						removeElement.attr('id', rowId);
						removeElement.find('div').html('');
						
						removeElement.click(function(){p.onRemove(this)});
					});
				}
